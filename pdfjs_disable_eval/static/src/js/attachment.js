odoo.define('pdfjs_disable_eval/static/src/js/attachment.js', function (require) {
'use strict';
    ...
    class Attachment extends dependencies['mail.model'] {
        ...
        _computeDefaultSource() {
            ...
            if (this.fileType === 'application/pdf') {
                return `/pdfjs_disable_eval/static/src/viewer.html?file=/web/content/${this.id}?model%3Dir.attachment#pagemode=none`;
            }
